...
final class SecurityAlertMessageFactory
{
    ...
    {
        return match ($key) {
            'employee_email' => $this->trans('Employee email', [], 'Modules.Mpadmin2fa.Emails'),
            'failures' => $this->trans('Failures', [], 'Modules.Mpadmin2fa.Emails'),
            'ip' => $this->trans('IP address', [], 'Modules.Mpadmin2fa.Emails'),
            'message' => $this->trans('Message', [], 'Modules.Mpadmin2fa.Emails'),
            'occurred_at' => $this->trans('Time', [], 'Modules.Mpadmin2fa.Emails'),
            'reason' => $this->trans('Reason', [], 'Modules.Mpadmin2fa.Emails'),
            'reset_by' => $this->trans('Reset by', [], 'Modules.Mpadmin2fa.Emails'),
            'scope' => $this->trans('Scope', [], 'Modules.Mpadmin2fa.Emails'),
