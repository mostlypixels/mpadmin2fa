...
final class GridCsrfTransportTest extends TestCase
{
    public function testGridTokensAreTransportedOnlyInPostBodies(): void
    {
        ...
        $employeeGrid = (string) file_get_contents(
            $root . '/src/Grid/Definition/Factory/EmployeeFactorGridDefinitionFactory.php'
        );
        $approvalGrid = (string) file_get_contents(
            $root . '/src/Grid/Definition/Factory/PendingApprovalGridDefinitionFactory.php'
        );
        $template = (string) file_get_contents(
            $root . '/views/PrestaShop/Admin/Common/Grid/Actions/Row/mp2fa_secure_submit.html.twig'
        );
