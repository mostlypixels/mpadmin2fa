...
10. Install this exact ZIP file on a clean PrestaShop 8 shop.
...
1. Push the `2.x-ps8` branch without tags.
...
Apply only the required commits to `2.x-ps8`.
Adapt the fix to Symfony 4.4 and PHP 7.2.5 through 8.1.
