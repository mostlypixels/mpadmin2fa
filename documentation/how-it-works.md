# How Admin 2FA works on PrestaShop 8
...
2. The interactive-login subscriber starts a new module session.
3. The request subscriber reads the employee from the security token.
4. The subscriber reads the employee factor and the policy.
5. The subscriber sends the employee to enrollment or to a challenge.
