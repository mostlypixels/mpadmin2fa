# Docker quick start for PrestaShop 8
...
| Service | Address |
| --- | --- |
| **Shop** | http://localhost:8101/ |
| **Secure shop** | https://localhost:8102/ |
...
1. Open a WSL terminal in the PrestaShop 8 worktree root.
...
4. Open https://localhost:8102/admin-dev/ and sign in.
